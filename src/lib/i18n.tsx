...
export const ui = {
  zh: {
    ...
    applyEmail: "工作信箱",
    applySubmit: "以電子郵件聯絡",
    applyPrivacy: "送出後將開啟電子郵件，寄至 hej@dansklyng.com。",
    applyDoneTitle: "請以電子郵件聯絡。",
    applyDoneBody: "請將洽詢寄至 hej@dansklyng.com，我們再回覆相關資訊。",
  ...
  en: {
    ...
    applyPrivacy: "Submit opens an email to hej@dansklyng.com.",
    applyDoneTitle: "Please write by email.",
    applyDoneBody: "Send the enquiry to hej@dansklyng.com and we will reply.",
