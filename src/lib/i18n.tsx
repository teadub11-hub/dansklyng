...
export const ui = {
  zh: {
    ...
    staffEyebrow: "ON THE SHELF",
    staffTitle: "貨架與店員怎麼講這三層",
    staffLine: "丹麥來的蜂蜜。招牌是石楠，另外三款跟著花期走。",
    staffLineNote: "十秒內講完。丹麥讓人相信，石楠讓人記住，四款讓人買得下手。",
    staffDo: "對消費者",
    staffDont: "不要做成",
    staffL1t: "DANSK 丹麥",
    staffL1do: "乾淨、可信、進口理由",
    staffL1dont: "hygge、設計雜貨、Viking",
    staffL2t: "LYNG 石楠",
    staffL2do: "深色、辛香、晚夏荒原",
    staffL2dont: "蘇格蘭幸運花、療效蜜",
    staffL3t: "四款系列",
    staffL3do: "從溫和到深沉，好選、好賣",
    staffL3dont: "四款平等、沒有招牌",
    staffShelfT: "貨架",
    staffShelf1: "石楠放視線高度，面數最多。",
    staffShelf2: "旁邊依花期：野花、晚夏、森林。由淺到深。",
    staffShelf3: "價簽與小卡只寫中文品名，不寫丹麥品名。",
    staffTalkT: "店員",
    staffTalk1t: "只看一眼",
    staffTalk1: "丹麥來的。招牌是這罐石楠。",
    staffTalk2t: "停下來",
    staffTalk2: "石楠長在日德蘭荒原，別的花謝了它才開。深紅、辛香，質地細、好塗。",
    staffTalk3t: "想選或送禮",
    staffTalk3: "想溫和走野花；想濃一點走晚夏；森林是蜜露，不是花蜜。招牌還是石楠。",
    staffTasteT: "試吃",
    staffTaste: "由淺到深，最後一口留給石楠。前面說明丹麥也有溫和的；最後一口才是品牌記憶。",
    staffAvoidT: "不要說",
    staffAvoid: "花語、幸運、療效、麥蘆卡、丹麥品名、箱規。",
  ...
  en: {
    ...
    productTradeBody: "Contact us for product details, samples and wholesale enquiries.",
    homeEyebrow: "DANISH HONEY · JUTLAND",
    ...
    staffEyebrow: "ON THE SHELF",
    staffTitle: "How to speak the three layers on the shelf",
    staffLine: "Danish honey. Heather is the signature. The other three follow the bloom.",
    staffLineNote: "Ten seconds. Denmark builds trust, heather is what they remember, the four make it easy to buy.",
    staffDo: "For the customer",
    staffDont: "Do not make it",
    staffL1t: "DANSK · Denmark",
    staffL1do: "Clean, trusted, a reason to import",
    staffL1dont: "hygge, design goods, Vikings",
    staffL2t: "LYNG · Heather",
    staffL2do: "Dark, spicy, the late-summer heath",
    staffL2dont: "Scottish lucky heather, a medicinal honey",
    staffL3t: "The four honeys",
    staffL3do: "From mild to deep. Easy to choose, easy to sell",
    staffL3dont: "Four equals, no signature",
    staffShelfT: "The shelf",
    staffShelf1: "Heather at eye level, with the most facings.",
    staffShelf2: "Beside it, by bloom: wildflower, late summer, forest. Pale to deep.",
    staffShelf3: "Shelf tickets use the local product name, not the Danish SKU name.",
    staffTalkT: "Staff",
    staffTalk1t: "A glance",
    staffTalk1: "Danish. The signature is this heather honey.",
    staffTalk2t: "They pause",
    staffTalk2: "Heather grows on the Jutland heath and flowers after the other blooms have gone. Dark, spicy, fine, easy to spread.",
    staffTalk3t: "They want to choose or give",
    staffTalk3: "Milder: wildflower. Fuller: late summer. Forest is honeydew, not blossom. The signature is still heather.",
    staffTasteT: "Tasting",
    staffTaste: "Pale to deep, last spoon heather. The first three show Denmark has a gentle side; the last spoon is the brand.",
    staffAvoidT: "Do not say",
    staffAvoid: "Flower language, luck, health claims, manuka, Danish SKU names, case packs.",
    ...
    journalLede:
      "Explore the Danish landscape, the heather heath and the moving hives, alongside the flavour, texture and table of each honey.",
