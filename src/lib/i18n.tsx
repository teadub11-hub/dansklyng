...
export const ui = {
  ...
  en: {
    ...
    applyPrivacy: "We use these details only to reply to this enquiry.",
    applyDoneTitle: "We have received your enquiry.",
    applyDoneBody: "We will write to the address you left. You can also email hej@dansklyng.com.",
    applyError: "It did not send. Please try again, or write to hej@dansklyng.com.",
    ...
    legalPrivacy:
      "Dansk Lyng is a Danish brand. Trade enquiry details are used only to reply to that enquiry, and are sent to hej@dansklyng.com. We do not sell personal data.",
